...
// Typ reprezentujący drzewo. Ta definicja znajduje się w pliku sync.h,
// bo obydwa pliki go zawierające (Tree.c i sync.c) potrzebują z niej
// swobodnie korzystać.
typedef struct Tree {
    Node *root;
...
// Zwolnienie pamięci związanej z wierzchołkiem i wszystkimi jego synami
void node_free(Node *);
...
bool start_read(Tree *, const char *);
...
bool start_write(Tree *, const char *, const char *);
